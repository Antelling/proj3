...
bool Term::operator> (Term &right) //checks if the incoming value is less than the exponent
{	/*********************************************************************
	*   Function name:  operator>
	*   Description:  Compares two Terms based on exponent
	*   Parameters: int value- the value to make the comparision to
...
bool Term::operator> (int right) //checks if the incoming value is less than the exponent
{	/*********************************************************************
	*   Function name:  operator>
	*   Description:  Compares Term's exponent to an int
	*   Parameters: int value- the value to make the comparision to
